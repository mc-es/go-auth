...
func setupLogger(t *testing.T, opts ...logger.Option) *testLogger {
	...
	allOpts := append([]logger.Option{
		logger.WithDriver(logger.DriverZerolog),
...
func TestLevels(t *testing.T) {
	tests := []struct {
		...
		{"debug", core.LevelDebug, zerolog.DebugLevel, true},
		{"info", core.LevelInfo, zerolog.InfoLevel, true},
		{"warn", core.LevelWarn, zerolog.WarnLevel, false}, // Info message won't appear at Warn level
		{"error", core.LevelError, zerolog.ErrorLevel, false},
		{"panic", core.LevelPanic, zerolog.PanicLevel, false},
		{"fatal", core.LevelFatal, zerolog.FatalLevel, false},
	}
