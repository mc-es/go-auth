...
func TestLevels(t *testing.T) {
	tests := []struct {
		...
		{"debug", core.LevelDebug, logrus.DebugLevel, true},
		{"info", core.LevelInfo, logrus.InfoLevel, true},
		{"warn", core.LevelWarn, logrus.WarnLevel, false}, // Info message won't appear at Warn level
		{"error", core.LevelError, logrus.ErrorLevel, false},
		{"panic", core.LevelPanic, logrus.PanicLevel, false},
		{"fatal", core.LevelFatal, logrus.FatalLevel, false},
	}
...
func TestDevelopment(t *testing.T) {
	...
	// In development mode, output might go to stdout instead of file
	if err != nil {
		return
	}
